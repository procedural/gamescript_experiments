#if 0
cl /LD sokol_gfx.c /DSOKOL_GLCORE33
move /y sokol_gfx.lib sokol_gfx.dll.lib
#endif

#define SOKOL_IMPL
#ifdef _WIN32
#define SOKOL_GFX_API_DECL __declspec(dllexport)
#define SOKOL_API_IMPL     __declspec(dllexport)
#endif
#include "sokol_gfx.h"
...
#pragma warning(disable:4055)   /* 'type cast': from data pointer */
    ...
    #define GL_LUMINANCE 0x1909
        ...
        #define _SOKOL_GL_INSTANCING_ENABLED
    #endif
    #define _SG_GL_CHECK_ERROR() // { SOKOL_ASSERT(glGetError() == GL_NO_ERROR); } // NOTE(Constantine)
#endif
