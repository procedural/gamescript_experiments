...
let WindowData_Frames_CommandBuffer_reusable         = [pointerGetAtOffsetUnsignedInteger(WindowData_Frames, 0 * 72 + 0 + redStructMemberOffsetof("RedCalls", "reusable")) == 1 ? true : false,             pointerGetAtOffsetUnsignedInteger(WindowData_Frames, 1 * 72 + 0 + redStructMemberOffsetof("RedCalls", "reusable")) == 1 ? true : false]
...
let WindowData_Frames_Framebuffer_depthStencilEnable = [pointerGetAtOffsetUnsignedInteger(WindowData_Frames, 0 * 72 + 48 + redStructMemberOffsetof("RedOutput", "depthStencilEnable")) == 1 ? true : false, pointerGetAtOffsetUnsignedInteger(WindowData_Frames, 1 * 72 + 48 + redStructMemberOffsetof("RedOutput", "depthStencilEnable")) == 1 ? true : false]
