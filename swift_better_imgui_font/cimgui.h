...
CIMGUI_API ImFont* ImFontAtlas_AddFontFromMemoryTTF(ImFontAtlas* self,const void* font_data,int font_size,float size_pixels,const ImFontConfig* font_cfg,const ImWchar* glyph_ranges);
...
CIMGUI_API void ImFontAtlas_SetTexID(ImFontAtlas* self,uint64_t id);
